...
export const CLIENTES: Cliente[] = [
	...
	{id: uuid(), nome: 'Vítor P. Corrêa', 		dataNascimento: new Date()},
	{id: uuid(), nome: 'Felipe Neto', 			dataNascimento: new Date()},
	{id: uuid(), nome: 'Victor Marson', 		dataNascimento: new Date()},
	{id: uuid(), nome: 'Ana Angélica Pires', 	dataNascimento: new Date()},
